...
$DMD -d -version=dmd2_053 -version=D2 myversion.d src/Log.d src/dzmq.d src/zmq_pp_broker_client.d src/zmq_point_to_poin_client.d src/libzmq_headers.d src/mq_client.d \
...
$DMD -d -version=dmd2_053 -version=D2 src/test_recieve.d src/Log.d src/zmq_point_to_poin_client.d src/libzmq_headers.d src/mq_client.d \
lib/libzmq.a lib/libstdc++.a lib/libuuid.a 

$DMD -d -version=dmd2_053 -version=D2 src/test_send.d src/Log.d src/zmq_point_to_poin_client.d src/libzmq_headers.d src/mq_client.d \
lib/libzmq.a lib/libstdc++.a lib/libuuid.a 
